...
const WhoWeAre = () => {
  return (
    <div className='flex flex-col items-center justify-center tracking-tight lg:px-28 px-10 pt-10 md:pt-0 md:px-28 gap-20'>
        <div className="flex flex-col md:flex-row lg:flex-row justify-between items-center">
            ...
            <img src="https://www.freeiconspng.com/thumbs/world-map-png/world-map-png-6.png" alt="" className='md:w-1/3 py-10'/>
        </div>
    </div>
  )
}
